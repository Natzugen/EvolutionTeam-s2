...
bool CRecordSet::bColumnEx(const int iCol, WORD * plOutVal)
{
	long piOutBufSz = 0;
	long totalLength=0;

	if(SQL_SUCCEEDED(SQLGetData( hSTMT, 1, SQL_C_BINARY,(SQLPOINTER) (plOutVal),(SQLINTEGER) 5000000,(SQLLEN *) &totalLength )))			
	{
		return true;
	}
	else {
