...
{
	this->m_Enabled = GetPrivateProfileInt("StoneExchanger","Enabled",1,NPCSTONEEXCHANGER_PATH);
...
{
	if(gObj[Monster].Class == 258) // Stone Exchanger
	{
		...
		ChatTargetSend(&gObj[Monster], "Thank you for stones! Take my credits.", aIndex);
